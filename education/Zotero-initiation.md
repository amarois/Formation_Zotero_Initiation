...
1. Des livres
    * [Via un plateforme de publication](https://books.openedition.org/enseditions/63096)
    * [Via un catalogue de BU](https://rechercher.bibliotheque-diderot.fr/permalink/33ENSL_INST/1djej89/alma9912171107208126)
    * [Via le Sudoc](https://www.sudoc.fr/285039393)
    * [Via le WorldCat](https://search.worldcat.org/fr/title/1520625165)
2. [Une communication à un congrès](https://hal.science/hal-04557106)
3. [Une thèse](https://theses.fr/2015PA040131)
4. [Un chapitre de livre](https://doi.org/10.3917/ems.frim.2019.01.0077)
5. [Un rapport](https://www.enseignementsup-recherche.gouv.fr/sites/default/files/2025-07/rapport-intelligence-artificielle-et-enseignement-sup-rieur-formation-structuration-et-appropriation-par-la-soci-t--37540.pdf)
6. [Un article de revue](https://journals.openedition.org/diversite/?id=3860)
...
- La référence _Histoire des femmes et histoire du genre dans l'Occident médiéval_ a des métadonnées très pauvres => complétez la notice Zotero à partir de ce que vous trouvez en consultant le pdf joint.

- Vous avez normalement un doublon dans votre bibliothèque Zotero (si vous n'avez pas supprimé les imports précédents) => [fusionnez les doublons](https://www.zotero.org/support/duplicate_detection) en faisant un choix judicieux au niveau de métadonnées
...
1. **[Créez une Collection](https://www.zotero.org/support/collections_and_tags#creating_collections)** nommée "Seignobos_R".
3. Revenez au niveau de Ma bibliothèque pour afficher toutes les références. **Triez** les références par la colonne Createur. **Sélectionnez** toutes celles dont un auteur est Robin Seignobos (Ctrl+clic ou Shift+clic).
4. **[Glissez-déposez](https://www.zotero.org/support/collections_and_tags#adding_items_to_collections)** les références dans la collection "Seignobos_R".
5. Suite à l'import précédent, vous devriez avoir une collection "Documents exportés". **Renommez**-la en "Tutos Zotero".
6. **Cherchez** "Initiation aux études historiques" dans votre bibliothèque Zotero. Affichez l'onglet marqueur de sa notice et **[supprimez les marqueurs](https://www.zotero.org/support/collections_and_tags#removing_tags_from_items)** importés automatiquement du sudoc. **[Ajoutez le marqueur](https://www.zotero.org/support/collections_and_tags#adding_tags_to_items)** "Référence" et "Méthodologie".
...
### Ajouter un style, utiliser un style, changer de style bibliographique
Zotero s'installe avec une liste réduite de styles bibliographiques de base. Vous allez apprendre à en installer d'autres et les tester :

1. Ouvrez Word ou LibreOffice. Créez un nouveau document "MonMémoireTest"; ajoutez quelques lignes de texte en faisant des appels de citation avec le [plugin Zotero](https://www.zotero.org/support/word_processor_plugin_usage) > **Add/Edit citation** (ou moins 2). Choisissez le **style Nature** lors du premier appel de citation.
2. Allez à la fin du document. Ajoutez un paragraphe et générez la bibliographie avec le plugin Zotero > **[Add/Edit Bibliography](https://www.zotero.org/support/word_processor_plugin_usage#bibliography)**.
3. Retournez dans Zotero. Allez dans Préférences > (onglet) Citer. Cliquez sur "**Obtenir plus de styles...**".
4. Dans la fenêtre "Zotero style repository" qui s'ouvre, cherchez le style **Triangle (Français)**. Cliquez sur le lien "Triangle (Français)" pour l'installer. Retournez dans l'onglet Citer, vérifiez que le style Triangle (Français) est bien présent dans le **Gestionnaire de styles**.
5. Retournez dans votre document MonMémoireTest, et changez le style de citation via **[Document Preferences](https://www.zotero.org/support/word_processor_plugin_usage#document_preferences)**. Choisir Triangle (Français). Les appels de citation et la bibliographie sont modifiés avec le nouveau style ! La forme change, le fond est conservé.

**Votre travail est de prendre soin du fond. Laissez faire la machine pour le reste.**

Astuce : c'est à ce stade souvent que l'on voit des coquilles (auteurs orthographiés différemment, coquilles dans les titres, "p." en trop, etc. ). Prenez l'habitude dans ce cas d'aller corriger _à la source, dans votre bibliothèque Zotero_ les erreurs, puis cliquez dans votre document sur Refresh au niveau du plugin Zotero. Ainsi, vous **capitalisez votre travail** de relecture en prenant soin de votre base de références.
